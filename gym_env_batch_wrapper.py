...
class SCD_ENV(gym.Env):
    ...
    def read_next_file(self):
        ...
        _1280_eps = np.load("./data/arr_" + str(self.npy_id+1) + ".npy")
    ...
    def get_cur_episode(self):
        ...
        self.cur_eps_id += 1   ### 判别当前使用哪一个 episode
    ...
    def step(self, actions_lst):
        ...
        info['cover'] = np.zeros((self.batch_size, 1))
        info['pure'] = np.zeros((self.batch_size, 1))
